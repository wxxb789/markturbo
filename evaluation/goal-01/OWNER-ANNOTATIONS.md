...
- Human source: `goals/02-guarantee-user-text-safety.md`, especially Product
...
- Human source: `goals/03-create-first-use-document-flow.md`, especially User
...
- Human source:
  `goals/05a-protect-model-credentials-and-request-privacy.md`, especially In
...
- Human source: `goals/06-deliver-read-only-intent-review.md`, especially Product
...
- Human source: `.agents/skills/gpui/SKILL.md` and its Navigation table.
...
- Human source: `.agents/skills/gpui-component/SKILL.md`, especially Read This
